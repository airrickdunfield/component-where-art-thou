...
```sh
npm install --save-dev "/Users/adunfield/Documents/ChatGPT/JSX Open in Code/packages/vite-plugin-jsx-locator"
```
...
import { jsxLocator } from 'vite-plugin-jsx-locator';

export default defineConfig({
  plugins: [react(), jsxLocator()],
});
```
